...
export const ui = {
	"en-SG": {
		...
		"chronicle.deno_jsr_desc":
			"Fully unified local development by migrating package management to pnpm and integrated JSR for high-performance dependency resolution.",
	...
	zh: {
		...
		"chronicle.deno_jsr_desc":
			"统一本地开发环境，将包管理器彻底迁移至更高效的 pnpm，并接入高性能的 JSR 包管理平台以优化依赖解析。",
